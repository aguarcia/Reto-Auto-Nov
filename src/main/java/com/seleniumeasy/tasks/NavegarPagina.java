...
public class NavegarPagina implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                WaitUntil.the(LNK_CONTRATO_TRANSPORTE, isVisible()).forNoMoreThan(10).seconds(),
                Click.on(LNK_CONTRATO_TRANSPORTE),
                WaitUntil.the(LNK_ANEXO_CONTRATO_TRANSPORTE, isVisible()).forNoMoreThan(10).seconds(),
